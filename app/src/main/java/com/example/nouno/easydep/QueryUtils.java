...
public class QueryUtils {
    ...
    public static final String LOCAL_LOGIN_URL = "http://192.168.1.2/EasyDep/login.php";
    public static final String LOCAL_SIGNUP_URL = "http://192.168.1.2/EasyDep/signup.php";
    ...
    public static final String LOCAL_GET_REPAIR_SERVICES_URL = "http://192.168.1.2/EasyDep/GetRepairServices.php";
    ...
    public static final String GET_USER_COMMENTS_LOCAL_URL = "http://192.168.1.2/EasyDep/comment.php";
    public static final String LOG_OUT_URL = "http://192.168.1.2/EasyDep/logout.php";
    public static final String SEND_REQUEST_URL = "http://192.168.1.2/EasyDep/send_request.php";
    public static final String GET_REQUESTS_URL = "http://192.168.1.2/EasyDep/get_requests.php";
